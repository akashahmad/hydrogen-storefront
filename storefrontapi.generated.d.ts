...
export type MetaBannerFragment = Pick<
...
export type MetaBannersQueryVariables = StorefrontAPI.Exact<{
  type: StorefrontAPI.Scalars['String']['input'];
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;

export type MetaBannersQuery = {
  metaobjects: {
    edges: Array<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment MetaBanner on Metaobject {\n    id\n    type\n    handle\n    fields {\n      key\n      value\n      type\n    }\n  }\n\n  query MetaBanners($type: String!, $first: Int = 50) {\n    metaobjects(type: $type, first: $first) {\n      edges {\n        node {\n          ...MetaBanner\n        }\n      }\n    }\n  }\n': {
    return: MetaBannersQuery;
    variables: MetaBannersQueryVariables;
  };
